...
namespace ChallengeSandboxTests
{
    ...
    public class LeetcodeChallengesTests
    {
        ...
        {
            //var tc1_nums1 = new int[] { 1, 2, 3, 0, 0, 0 };
            //var tc1_m = 3;
            //var tc1_nums2 = new int[] { 2, 5, 6 };
            //var tc1_n = 3;
            //var tc1_expected = new int[] { 1, 2, 2, 3, 5, 6 };

            //leetcodeChallenges.MergeSortedArrays(tc1_nums1, tc1_m, tc1_nums2, tc1_n);
            //Assert.That(tc1_nums1, Is.EquivalentTo(tc1_expected));

            var tc2_nums1 = new int[] { 2, 0 };
            var tc2_m = 1;
            var tc2_nums2 = new int[] {1};
            var tc2_n = 1;
            var tc2_expected = new int[] { 1, 2 };

            leetcodeChallenges.MergeSortedArrays(tc2_nums1, tc2_m, tc2_nums2, tc2_n);
            Assert.That(tc2_nums1, Is.EquivalentTo(tc2_expected));

            var tc3_nums1 = new int[] { -1, 0, 0, 3, 3, 3, 0, 0, 0 };
            var tc3_m = 6;
            var tc3_nums2 = new int[] { 1, 2, 2 };
            var tc3_n = 3;
            var tc3_expected = new int[] { -1, 0, 0, 1, 2, 2, 3, 3, 3 };

            leetcodeChallenges.MergeSortedArrays(tc3_nums1, tc3_m, tc3_nums2, tc3_n);
            Assert.That(tc3_nums1, Is.EquivalentTo(tc3_expected));
        }
    }
}
